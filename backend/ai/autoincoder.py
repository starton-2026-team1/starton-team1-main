"""
Step 3: Autoencoder 구현 및 학습
논문 3.3, 4.2 구현

구조: 36 → 16 → 36 (단층 오토인코더)
- 정상 데이터로만 학습
- 이상치 판별 임계값: 3%
"""
...
def build_autoencoder(input_dim=36, hidden_dim=16):
    """단층 오토인코더 (논문 그림 5)"""
...
if __name__ == "__main__":
    ...
    # 모델 빌드 및 학습
    ae = build_autoencoder(input_dim=36, hidden_dim=16)
    ae.summary()
